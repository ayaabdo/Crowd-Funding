...
urlpatterns = [
    ...
    url(r'^project/(?P<project_id>\d+)/delete$', projects.delete, name='project_delete'),
    ...
    url(r'^comment/(?P<project_id>\d+)/(?P<comment_id>\d+)/delete$',useractions.deletecomment, name='comment_delete'),
